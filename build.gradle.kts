...
mavenPublishing {
    coordinates("one.wabbit", "scala-std-data-hash-mhash", "0.0.1")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("scala-std-data-hash-mhash")
        description.set("scala-std-data-hash-mhash")
        url.set("https://github.com/wabbit-corp/scala-std-data-hash-mhash")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/scala-std-data-hash-mhash")
            connection.set("scm:git:git://github.com/wabbit-corp/scala-std-data-hash-mhash.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/scala-std-data-hash-mhash.git")
        }
    }
}
